...
bundle t(:bundle_name) do |bundle|
  ...
  bundle.menu t(:bundle_name) do |submenu|
      ...
      submenu.menu t(:Route) do |submenu2|
        # 2012.8.2 Done
        submenu2.command 'Route::get(\'\', function(){})'
        submenu2.command 'Route::post(\'\', function(){})'
        submenu2.command 'Route::any(\'\', function(){})'
        submenu2.command 'Route::filter(\'\', function(){})'
        submenu2.command 'Route::group(\'\', function(){})'
		submenu2.separator
        submenu2.command 'where(\'\', \'\')'
